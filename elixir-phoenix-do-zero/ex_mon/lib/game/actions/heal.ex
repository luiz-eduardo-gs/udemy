defmodule ExMon.Game.Actions.Heal do
  ...
  defp calculate_total_life(life), do: Enum.random(@heal_avg_power) + life
  ...
  defp update_game(player_struct, player, life) do
    Game.info()
    |> Map.put(player, player_struct)
    |> Game.update()
